...
public class RegisterActivity extends AppCompatActivity {
    ...
    public native int validateInputsFromNative(String email, String password, String username);

    private boolean validateInputs() {
        String email = binding.editTextTextEmailAddressRegisr.getText().toString();
        String password = binding.editTextTextPasswordRegistr.getText().toString();
        String username = binding.editTextTextUsername.getText().toString();

        // Вызов нативной функции
        int validationResult = validateInputsFromNative(email, password, username);
